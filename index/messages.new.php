...
<body onresize="windowActs.windowResize()">

<div class="back" onclick='manuActs.closeSetBarAct()'></div>
    ...
    <div class='dialogs-main-wrap'>
        <div class='search-dialogs-wrap'>
            <form id='search-dialogs-form' method='post'>
                ...
                <input class='search-dialogs-field' placeholder='Поиск' name='search-text' type='text' oninput='searchOninput(this)'/>
            </form>
        </div>
